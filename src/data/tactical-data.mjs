...
export const TACTIC_LESSONS = Object.freeze({
  motion: Object.freeze({
    ...
    timeline: Object.freeze({
      ...
      actors: Object.freeze([
        { id: "pg", side: "offense", label: "1", role: "控球" },
        { id: "sg", side: "offense", label: "2", role: "射手" },
        { id: "sf", side: "offense", label: "3", role: "底角" },
        { id: "pf", side: "offense", label: "4", role: "弱侧" },
        { id: "c", side: "offense", label: "5", role: "中轴" },
      ]),
      ...
      beats: Object.freeze([
        { t: 0, label: "启动", text: "五人拉开，1号持球吸引第一层压力。" },
        { t: 1150, label: "中轴", text: "5号上提接球，让球离开夹击区域。" },
        { t: 2700, label: "转弱侧", text: "3号底角接到转移，弱侧空间被打开。" },
        { t: 4300, label: "二次转移", text: "2号接二传，防守继续横移。" },
        { t: 5350, label: "收尾", text: "4号短顺接应，形成终结或再分球。" },
      ]),
  ...
  paint: Object.freeze({
    ...
    timeline: Object.freeze({
      ...
      durationMs: 6200,
      actors: Object.freeze([
        { id: "poa", side: "defense", label: "1", role: "领防" },
        { id: "nail", side: "defense", label: "2", role: "钉位" },
        { id: "low", side: "defense", label: "3", role: "弱侧" },
        { id: "xout", side: "defense", label: "4", role: "底角" },
        { id: "rim", side: "defense", label: "5", role: "护框" },
      ]),
      tracks: Object.freeze({
      ...
      beats: Object.freeze([
        { t: 0, label: "压迫起点", text: "1号先顶住持球压力。" },
        { t: 1300, label: "弱侧回收", text: "3号和4号向禁区内收，优先堵突破路线。" },
        { t: 2550, label: "护框成型", text: "5号站到篮下，五人形成禁区墙。" },
        { t: 3650, label: "底角代价", text: "球转到底角，4号必须追出去。" },
        { t: 5050, label: "二次轮转", text: "2号补侧翼，其他人回到篮板位置。" },
      ]),
